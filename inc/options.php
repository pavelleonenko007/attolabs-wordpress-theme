...
if ( function_exists( 'acf_add_local_field_group' ) && function_exists( 'pll_the_languages' ) ) {
	...
	$other_fields = array(
		...
		array(
			...
			'aria-label'        => '',
			'type'              => 'email',
			'instructions'      => 'Add an email address to which emails from the site will be sent.',
			'required'          => 0,
			'conditional_logic' => 0,
			'wrapper'           => array(
				'width' => '',
		...
		array(
			'key'               => 'field_job_email',
			'label'             => 'Email for vacancies',
			'name'              => 'job_email',
			'aria-label'        => '',
			'type'              => 'email',
			'instructions'      => 'Add an email address to which you will receive job responses. If left empty, messages will be sent to the Contact Email.',
			'required'          => 0,
			'conditional_logic' => 0,
			'wrapper'           => array(
				'width' => '',
