			...
			<div class="barba-container blackmenu">
				<div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="nav w-nav">
					<header class="header"><a href="/" class="brand w-nav-brand"><img src="<?php echo get_template_directory_uri() ?>/images/65e02d40c169cf7705bd3a4a_logo.svg" loading="lazy" alt class="logo"></a>
						<nav role="navigation" class="w-nav-menu"><a href="/projects" class="navlink w-nav-link">What we do</a><a href="/about" class="navlink w-nav-link">Who we are</a><a href="/work-with-us" class="navlink w-nav-link">Work with us</a><a href="/jobs" aria-current="page" class="navlink w-nav-link w--current">Jobs</a>
				...
				<section class="section main-section jobs-pager">
					<div class="container _100vh jobs-page">
						<div>
							<p class="p-12-120 joj">Joining AttoLabs means being part of a team that values creativity, diversity, and growth. Here, you'll have the opportunity to work on cutting-edge projects that have a real impact on industries and communities worldwide.</p>
						</div>
						<h1 class="p-76-92">AttoLabs: Where Innovation, Community, and Impact Converge for Career Excellence in Technology Transformation</h1>
					</div>
				</section>
				<section class="section bg--fff7f3-2">
					<div class="container secnd _3 jobs-core">
						<div class="filter-block-mob job-pager">
							<div class="p-18-120 top-he">Open positions (<span class="count">12</span>)</div>
							...
							<div class="filters-block">
								<div class="w-form">
									<form id="email-form-4" name="email-form-4" data-name="Email Form 4" method="get" data-wf-page-id="65dc28b2adbd672d4103d4fe" data-wf-element-id="bb7b618a-69b2-8f5c-88ab-3e31c69f4a13">
										<div class="droper-filter">
											<div class="drpoter-block">
												<div class="p-12-120">Department (4)</div><img src="<?php echo get_template_directory_uri() ?>/images/65d85ded4d043968d9a1a5d9_chevron.svg" loading="lazy" alt class="image-2 no-mob"></div>
...
<input type="checkbox" id="checkbox-7" name="checkbox-7" data-name="Checkbox 7" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-7">Development</span></label>
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-2"></div>
<input type="checkbox" id="checkbox-2" name="checkbox-2" data-name="Checkbox 2" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-2">Support</span></label>
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-3"></div>
<input type="checkbox" id="checkbox-3" name="checkbox-3" data-name="Checkbox 3" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-3">Analytics</span></label>
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-4"></div>
<input type="checkbox" id="checkbox-4" name="checkbox-4" data-name="Checkbox 4" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-4">Others</span></label></div>
										</div>
										<div class="droper-filter">
											<div class="drpoter-block">
												<div class="p-12-120">Location (4)</div><img src="<?php echo get_template_directory_uri() ?>/images/65d85ded4d043968d9a1a5d9_chevron.svg" loading="lazy" alt class="image-2 no-mob"></div>
											<div class="droper-content">
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-5"></div>
<input type="checkbox" id="checkbox-5" name="checkbox-5" data-name="Checkbox 5" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-5">Germany, Köln</span></label>
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-6"></div>
<input type="checkbox" id="checkbox-6" name="checkbox-6" data-name="Checkbox 6" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-6">Uzbekistan, Tashkent</span></label>
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-6"></div>
<input type="checkbox" id="checkbox-6" name="checkbox-6" data-name="Checkbox 6" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-6">Tajikistan, Khujand</span></label>
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-6"></div>
<input type="checkbox" id="checkbox-6" name="checkbox-6" data-name="Checkbox 6" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-6">Türkiye, İstanbul</span></label></div>
										</div>
										<div class="droper-filter">
											<div class="drpoter-block">
												<div class="p-12-120">Job type</div><img src="<?php echo get_template_directory_uri() ?>/images/65d85ded4d043968d9a1a5d9_chevron.svg" loading="lazy" alt class="image-2 no-mob"></div>
											<div class="droper-content">
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-5"></div>
<input type="checkbox" id="checkbox-5" name="checkbox-5" data-name="Checkbox 5" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-5">On-site</span></label>
<label class="w-checkbox rdb"><div class="w-checkbox-input w-checkbox-input--inputType-custom radio-button" for="checkbox-6"></div>
<input type="checkbox" id="checkbox-6" name="checkbox-6" data-name="Checkbox 6" style="opacity:0;position:absolute;z-index:-1"><span class="radio-button-label w-form-label" for="checkbox-6">Remote</span></label></div>
										</div>
									</form>
						...
						<div class="jobs-mom-form w-form">
							<form id="email-form-2" name="email-form-2" data-name="Email Form 2" method="get" class="jobs-form" data-wf-page-id="65dc28b2adbd672d4103d4fe" data-wf-element-id="e9aa1461-cfa6-6ef1-cffd-068ffa8cc9dc">
								<div class="p-18-120 top-he">Open positions (<span class="count">12</span>)</div>
								<div class="flex-left"><a href="#" class="clear-filters">Clear filters</a>
									<div class="cl-fltrs"></div>
									<div class="job-droper">
										<div class="job-droper-a">
											<div class="p-12-120 uper">Department</div>
											<div class="p-12-120 top-counter"></div><img src="<?php echo get_template_directory_uri() ?>/images/65d85ded4d043968d9a1a5d9_chevron.svg" loading="lazy" alt class="image-2"></div>
										<div class="job-droper-in">
											<div class="job-droper-in_content">
												<div class="flex-vert">
<label class="rdb w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio-button w-radio-input"></div>
<input type="radio" name="type" id="radio" data-name="type" style="opacity:0;position:absolute;z-index:-1" value="Radio"><span class="radio-button-label w-form-label" for="radio">Development</span></label>
<label class="rdb w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio-button w-radio-input"></div>
<input type="radio" name="type" id="radio" data-name="type" style="opacity:0;position:absolute;z-index:-1" value="Radio"><span class="radio-button-label w-form-label" for="radio">Development</span></label>
<label class="rdb w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio-button w-radio-input"></div>
<input type="radio" name="type" id="radio" data-name="type" style="opacity:0;position:absolute;z-index:-1" value="Radio"><span class="radio-button-label w-form-label" for="radio">Development</span></label>
<label class="rdb w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio-button w-radio-input"></div>
<input type="radio" name="type" id="radio" data-name="type" style="opacity:0;position:absolute;z-index:-1" value="Radio"><span class="radio-button-label w-form-label" for="radio">Development</span></label></div>
												<div class="flex-horiz"><a href="#" class="job-btn">Apply</a><a href="#" class="job-btn close">Close</a></div>
											</div>
										</div>
									</div>
									<div class="job-droper">
										<div class="job-droper-a">
											<div class="p-12-120 uper">Location</div><img src="<?php echo get_template_directory_uri() ?>/images/65d85ded4d043968d9a1a5d9_chevron.svg" loading="lazy" alt class="image-2"></div>
										<div class="job-droper-in">
											<div class="job-droper-in_content">
												<div class="flex-vert">
<label class="rdb w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio-button w-radio-input"></div>
...
<input type="radio" name="type" id="radio" data-name="type" style="opacity:0;position:absolute;z-index:-1" value="Radio"><span class="radio-button-label w-form-label" for="radio">Development</span></label></div>
									...
									<div class="job-droper">
										<div class="job-droper-a">
											...
											<div class="p-12-120 top-counter"><sup>3</sup></div><img src="<?php echo get_template_directory_uri() ?>/images/65d85ded4d043968d9a1a5d9_chevron.svg" loading="lazy" alt class="image-2"></div>
										<div class="job-droper-in">
											<div class="job-droper-in_content">
												<div class="flex-vert">
<label class="rdb w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom radio-button w-radio-input"></div>
...
<input type="submit" data-wait="Please wait..." class="hide w-button" value="Submit"></form>
							<div class="w-form-done">
								<div>Thank you! Your submission has been received!</div>
							</div>
							<div class="w-form-fail">
						...
						<div class="jobs-core underfilter">
							<div id="w-node-_5dd46d37-ec32-59e7-3b21-59525383b3dc-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">Software Engineer</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
										<div>Development</div>
									</div>
									<div class="jb-2">
										<div class="job-in-drop">
											<div class="job-drop-btn morethenone">
												<div>Germany, Köln (+2)</div>
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-_334f80db-d63c-58b3-0742-a949fe6832c9-4103d4fe">Germany, Köln</div>
													<div id="w-node-e4795563-5c9d-4937-0da7-2b502d981aaf-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-_57d44448-817f-9956-620d-41188fb0a233-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="w-node-d532e5f9-2258-9b6d-1fe1-86db01039400-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">Data Scientist</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
										<div>Development</div>
									</div>
									<div class="jb-2">
										<div class="job-in-drop">
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-d532e5f9-2258-9b6d-1fe1-86db0103940f-4103d4fe">Germany, Köln</div>
													<div id="w-node-d532e5f9-2258-9b6d-1fe1-86db01039411-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-d532e5f9-2258-9b6d-1fe1-86db01039413-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="w-node-_3de1a6e5-8b15-eb69-461e-d2b7bab241c7-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">Quality Assurance Analyst</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
										<div>Development</div>
									</div>
									<div class="jb-2">
										<div class="job-in-drop">
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-_3de1a6e5-8b15-eb69-461e-d2b7bab241d6-4103d4fe">Germany, Köln</div>
													<div id="w-node-_3de1a6e5-8b15-eb69-461e-d2b7bab241d8-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-_3de1a6e5-8b15-eb69-461e-d2b7bab241da-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="w-node-_5baeb874-ed38-cc4c-4ada-c2cc6464c8b0-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">UX/UI Designer</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
										<div>Development</div>
									</div>
									<div class="jb-2">
										<div class="job-in-drop">
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-_5baeb874-ed38-cc4c-4ada-c2cc6464c8bf-4103d4fe">Germany, Köln</div>
													<div id="w-node-_5baeb874-ed38-cc4c-4ada-c2cc6464c8c1-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-_5baeb874-ed38-cc4c-4ada-c2cc6464c8c3-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="w-node-_641707bd-91b8-dc32-e235-35fc2c5bed78-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">Business Analyst</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
										<div>Development</div>
									</div>
									<div class="jb-2">
										<div class="job-in-drop">
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-_641707bd-91b8-dc32-e235-35fc2c5bed87-4103d4fe">Germany, Köln</div>
													<div id="w-node-_641707bd-91b8-dc32-e235-35fc2c5bed89-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-_641707bd-91b8-dc32-e235-35fc2c5bed8b-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="w-node-_0a81af52-1332-ade1-05fb-fedfd215dbce-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">Cloud Solutions Architect</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
										<div>Development</div>
									</div>
									<div class="jb-2">
										<div class="job-in-drop">
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-_0a81af52-1332-ade1-05fb-fedfd215dbdd-4103d4fe">Germany, Köln</div>
													<div id="w-node-_0a81af52-1332-ade1-05fb-fedfd215dbdf-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-_0a81af52-1332-ade1-05fb-fedfd215dbe1-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="w-node-_02a65be1-df32-5288-bd2c-fb8080360c93-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">Software Engineer</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
									...
									<div class="jb-2">
										<div class="job-in-drop">
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-_02a65be1-df32-5288-bd2c-fb8080360ca2-4103d4fe">Germany, Köln</div>
													<div id="w-node-_02a65be1-df32-5288-bd2c-fb8080360ca4-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-_02a65be1-df32-5288-bd2c-fb8080360ca6-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
							...
							<div id="w-node-c862df51-3d3e-ae3b-b5ce-d12c925555e9-4103d4fe" class="jobs-item">
								<div class="rel">
									<div class="jobs-name">Data Scientist</div><a href="/jobs-slngle" class="abs-link w-inline-block"></a></div>
								<div class="jobs-ins">
									<div class="jb-1">
									...
									<div class="jb-2">
										<div class="job-in-drop">
											...
											<div class="job-drop-content">
												<div class="job-drop-content_in">
													<div id="w-node-c862df51-3d3e-ae3b-b5ce-d12c925555f8-4103d4fe">Germany, Köln</div>
													<div id="w-node-c862df51-3d3e-ae3b-b5ce-d12c925555fa-4103d4fe">Türkiye, İstanbul</div>
													<div id="w-node-c862df51-3d3e-ae3b-b5ce-d12c925555fc-4103d4fe">Uzbekistan, Tashkent</div>
												</div>
											</div>
										</div>
									</div>
...
<input class="input-normal w-input" maxlength="256" name="field-4" data-name="Field 4" placeholder="JOHN JOHNSON" type="text" id="field-4" required></div>
										<div id="w-node-_2918af35-b134-b011-bc88-063920f2dc8b-4103d4fe" class="input-keeper">
											<div class="form-label">EMAIL</div>
<input class="input-normal w-input" maxlength="256" name="field-2" data-name="Field 2" placeholder="ADDRESS@MAIL.COM" type="email" id="field-2" required></div>
										<div id="w-node-_2918af35-b134-b011-bc88-063920f2dc8f-4103d4fe" class="input-keeper">
											<div class="form-label">PHONE NUMBER</div>
<input class="input-normal w-input" maxlength="256" name="field-2" data-name="Field 2" placeholder="0617084035" type="tel" id="field-2" required></div>
...
<label id="incroyable" class="cont-ref caller w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom call-dot w-radio-input"></div>
<input type="radio" name="connectionref" id="call" data-name="connectionref" style="opacity:0;position:absolute;z-index:-1" value="call"><span class="call-text w-form-label" for="call">Call</span></label>
												<div class="reger"></div>
<label class="cont-ref w-radio"><div class="w-form-formradioinput w-form-formradioinput--inputType-custom call-dot w-radio-input"></div>
<input type="radio" name="connectionref" id="Messenger" data-name="connectionref" style="opacity:0;position:absolute;z-index:-1" value="Messenger"><span class="call-text w-form-label" for="Messenger">Messenger</span></label></div>
										</div>
										<div id="w-node-_2918af35-b134-b011-bc88-063920f2dca0-4103d4fe" class="input-keeper textarer">
											<div class="form-label">Message</div>
<textarea placeholder="TALK ABOUT YOUR DREAM JOB" maxlength="5000" id="field-4" name="field-4" data-name="Field 4" class="input-normal textarea w-input"></textarea></div>
...
<input class="input-normal cv-link w-input" maxlength="256" name="field-2" data-name="Field 2" placeholder="INSERT A LINK" type="text" id="field-2" required></div>
										</div>
<label id="w-node-_2918af35-b134-b011-bc88-063920f2dcac-4103d4fe" class="w-checkbox checkbox-field"><div class="w-checkbox-input w-checkbox-input--inputType-custom checkbox" for="checkbox-3"></div>
<input type="checkbox" id="checkbox-3" name="checkbox-3" data-name="Checkbox 3" style="opacity:0;position:absolute;z-index:-1"><span class="p-12-120 ww fomr-c w-form-label" for="checkbox-3">I agree with the <a href="#" class="link">Privacy Policy</a></span></label></div>
								</div>
							</div>
<input type="submit" data-wait="Please wait..." fs-formsubmit-element="reset" class="submit-re fs_formsubmit_button n-fowm w-button" value="Send"></form>
					...
					<div class="top-stykert">
						<div class="tline ll"><a href="#" class="tlink main-tlink formpp">Didn’t find the desired position?</a>
				...
				<footer class="footer">
					<div class="container foo-core">
						<div id="w-node-_1439d612-918a-ada2-0e4f-0f03fce8b1c4-fce8b1c2" class="vert"><a href="/" class="w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/65defa42e065c3584e54a6fb_AttoLabs_logo.png" loading="lazy" alt class="logo-foo"></a>
							<div class="menu-vert"><a href="/" class="foo-link">Home</a><a href="/projects" class="foo-link">What We Do</a><a href="/about" class="foo-link">Who We Are</a><a href="/work-with-us" class="foo-link">Work With Us</a><a href="/jobs" aria-current="page" class="foo-link w--current">Jobs</a></div>
						</div>
