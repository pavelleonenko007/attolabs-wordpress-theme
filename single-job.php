<?php
/*
Template name: jobs-slngle
*/
?>
    <!DOCTYPE html>
<html data-wf-page="65dc4b44b768e5a87400cdd1" data-wf-site="65ae21eab8e90d9757d32cc8">
...
<label id="w-node-_9f3e7290-dede-9b21-bf0e-914aeb30f8c9-7400cdd1" class="w-checkbox checkbox-field"><div class="w-checkbox-input w-checkbox-input--inputType-custom checkbox" for="checkbox"></div>
<input type="checkbox" id="checkbox" name="checkbox" data-name="Checkbox" style="opacity:0;position:absolute;z-index:-1"><span class="p-12-120 ww fomr-c w-form-label" for="checkbox">I agree with the <a href="#" class="link">Privacy Policy</a></span></label></div>
								</div>
							</div>
