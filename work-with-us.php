				...
				<footer class="footer">
					<div class="container foo-core">
						<div id="w-node-_1439d612-918a-ada2-0e4f-0f03fce8b1c4-fce8b1c2" class="vert"><a href="/" class="w-inline-block"><img src="<?php echo get_template_directory_uri() ?>/images/65defa42e065c3584e54a6fb_AttoLabs_logo.png" loading="lazy" alt class="logo-foo"></a>
							<div class="menu-vert"><a href="/" class="foo-link">Home</a><a href="/projects" class="foo-link">What We Do</a><a href="/about" class="foo-link">Who We Are</a><a href="/work-with-us" aria-current="page" class="foo-link w--current">Work With Us</a><a href="/jobs" class="foo-link">Jobs</a></div>
						</div>
